<?php 
    ...
    setcookie($cookie_draft, $cookie_draft_value, time() + 24 * 3600);
    //domestic
    $cookie_domestic = "domestic";
    $cookie_domestic_value = 7;
    setcookie($cookie_domestic, $cookie_domestic_value, time() + 24 * 3600);
    //non-alcoholic drink
    $cookie_nonAlc = "nonAlcoholic";
    $cookie_nonAlc_value = 6;
    setcookie($cookie_nonAlc, $cookie_nonAlc_value, time() + 24 * 3600);
    //liquor
    $cookie_liquor = "liquor";
    $cookie_liquor_value = 10;
    setcookie($cookie_liquor, $cookie_liquor_value, time() + 24 * 3600);
    //House wine
    $cookie_hwine = "housewine";
    $cookie_hwine_value = 10;
    setcookie($cookie_hwine, $cookie_hwine_value, time() + 24 * 3600);
    //Premium wine
    $cookie_pwine = "premiumwine";
    $cookie_pwine_value = 12;
    setcookie($cookie_pwine, $cookie_pwine_value, time() + 24 * 3600);
    //Single Malt 10
    $cookie_singlemalt10 = "singlemalt10";
    $cookie_singlemalt10_value = 20;
    setcookie($cookie_singlemalt10, $cookie_singlemalt10_value, time() + 24 * 3600);
    //Single Malt 15
    $cookie_singlemalt15 = "singlemalt15";
    $cookie_singlemalt15_value = 25;
    setcookie($cookie_singlemalt15, $cookie_singlemalt15_value, time() + 24 * 3600);
    //Juice
    $cookie_juice = "juice";
    $cookie_juice_value = 6;
    setcookie($cookie_juice, $cookie_juice_value, time() + 24 * 3600);
    //Pop
    $cookie_pop = "pop";
    $cookie_pop_value = 4;
    setcookie($cookie_pop, $cookie_pop_value, time() + 24 * 3600);
?>
...
<body>
    ...
    <div class="salesAmountAndQuantity">
        <table id="total">
            <caption class="tableCaption">Total</caption>
            <tr>
                <th> </th>
                <th>Pint</th>
